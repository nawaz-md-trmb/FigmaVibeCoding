...
const _ICON_MAP = {
  ...
  RefreshCw:'sync',Plus:'add',Edit:'pencil',Star:'star',ThumbsUp:'thumbs_up',ThumbsDown:'thumbs_down',
};
...
export function InteractiveAgenticBasicChat({
  ...
  const composerBarClassName = compactEmbedded
    ? "border-t border-[var(--modus-wc-color-base-200)] bg-[var(--modus-wc-color-base-page)] px-3 pb-2 pt-2"
